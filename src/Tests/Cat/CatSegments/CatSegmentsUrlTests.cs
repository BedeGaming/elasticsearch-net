	...
	public class CatSegmentsUrlTests : IUrlTests
	{
		[U] public async Task Urls()
		{
			...
			await GET("/_cat/segments/project")
				...
				.Request(c => c.CatSegments(new CatSegmentsRequest(Best.Indices.Index<Project>())))
				.FluentAsync(c => c.CatSegmentsAsync(r => r.Index<Project>()))
				.RequestAsync(c => c.CatSegmentsAsync(new CatSegmentsRequest(Best.Indices.Index<Project>())));
		}
	}
}
