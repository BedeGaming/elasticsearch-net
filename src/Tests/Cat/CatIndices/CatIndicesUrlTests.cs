	...
	public class CatIndicesUrlTests : IUrlTests
	{
		[U] public async Task Urls()
		{
			...
			await GET("/_cat/indices/project")
				...
				.Request(c => c.CatIndices(new CatIndicesRequest(Best.Indices.Index<Project>())))
				.FluentAsync(c => c.CatIndicesAsync(i => i.Index<Project>()))
				.RequestAsync(c => c.CatIndicesAsync(new CatIndicesRequest(Best.Indices.Index<Project>())))
				;
		}
	}
}
